...
ventana = Tk()
ventana.title("Calcula con Carlos jeje")
#creo un indice nuevo para que el numero se imprima en el lugar adecuado
i = 0
#entrada de txt

e_texto =Entry(ventana, font = ("Calibriti 20"))
...
def click_boton(valor):
    ...
    i += 1
    #el i += 1 es para sumarle un indice mayor 

#Para borrar vamos a crear una nueva funcion y colocar esta funcion en su lamnbda
def borrar():
    e_texto.delete(0, END)
    i = 0

#Creamos una funcion que haga toda la operacion escrita, usando la funcion "aval" hace toda la operacion     
#y toda esta funcion se la damos al simbolo igual
def operacion():
...
boton_rst = Button(ventana, text = "-", width = 5, height = 2, command = lambda: click_boton("-"))
...
boton_rst.grid(row = 4, column = 3 ,padx = 5, pady = 5)
